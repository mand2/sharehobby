    ...
    <div class = "wrap">
        ...
        <form>
            <div id="regForm">
                ...
                <div class="warning">
                    <label for="pw2"><h4>비밀번호 재확인</h4></label>
                    <span class="inputbox"><input id="pw2" class="input"></span>
                    <h5></h5>
                </div>
                
                <div class="warning">
                    <label for="name"><h4>이름</h4></label>
                    <span class="inputbox"><input id="name" class="input"></span>
                    <h5></h5>
                </div>
                ...
                <div class="warning">
                    ...
                    <div id="birthbox">
                        <span class="inputbox birth"><input id="y" class="input" placeholder="연도"></span>
