...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
		try {
			//String jdbcUrl = "jdbc:mysql://localhost:3306/sh?" + "useUnicode=true&characterEncoding=utf8&serverTimezone=UTC"; 
			String jdbcUrl = "jdbc:oracle:thin:@oracle11gr2.cwhk40ilcba1.ap-northeast-2.rds.amazonaws.com:1521:orcl";
